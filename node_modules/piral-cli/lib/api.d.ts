import { ToolCommand, ToolCommandRunner, ToolCommandWrapper, ToolCommandFlagsSetter, RuleRunner, PiralRuleContext, PiletRuleContext, PackagePatcher, BundlerDefinition, ReleaseProvider } from './types';
...
export declare function withReleaseProvider(name: string, action: ReleaseProvider): any;
