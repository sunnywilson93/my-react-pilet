...
export declare function getTemplates(entry: Configuration['entry']): string[];
export declare function replaceEntries(existingEntries: Array<string>, oldEntry: string, newEntries: Array<string>): void;
export declare function setEntries(config: Configuration, template: string, entries: Array<string>): void;
